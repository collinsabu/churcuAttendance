        ...
        <div className="w-[100%] sm:mt-10 mt-2 flex flex-col items-center">
          <div>
            <Link href="/attendance">
              <div className=" bg-bg-green py-3 h-10 sm:px-[90px] px-[50px] flex items-center font-bold text-md hover:bg-bg-green text-white hover:text-green-300 my-5 sm:mb-7">
                <span className="mr-2">
                  <FaHome />
                </span>{" "}
                Attendance
            ...
            <Link href="/firsttimerlist">
              <div className=" bg-bg-green py-3 h-10 w-[100%] flex justify-center items-center  font-bold text-md hover:bg-bg-green text-white hover:text-green-300 my-5 sm:my-7">
                <span className="mr-2">
                  <MdGroups2 />
                </span>
                First Timers
