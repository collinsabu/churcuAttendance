...
export default function SideBar({isOpen}) {
  return isOpen && (
    <>
          <nav className="position: fixed  sm:left-4 left-1 top-[79px] sm:bottom-4  sm:bg-white bg-green-300  sm:w-[20%] w-[70%] sm:rounded-2xl rounded-[40px] sm:pt-10 pt-4 px-4 flex-col items-center pb-7 sm:pb-0 sm:hidden">
